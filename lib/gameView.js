(function () {
  ...
  GameView.prototype.setupListeners = function(){
    ...
    $("#30").on("click", function(){window.options.frameRateMod = 1;});
    $("#60").on("click", function(){window.options.frameRateMod = 2;});
  ...
  GameView.prototype.setupGlobals = function () {
    ...
    //For tracking additional centipede segments
    window.centipedeIndex = 16;
    //Used to keep track of the mushrooms and their hitboxes as they are generated
    //and destroyed
  ...
  GameView.prototype.start = function () {
    ...
    this.timerId = setInterval(
      ...
      }.bind(this), 1000 / (Centipede.Game.FPS * window.options.frameRateMod) //
    );
    this.setupKeys();
